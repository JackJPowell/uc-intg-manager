...
export function SettingsPage() {
  ...
  return <section className="settings-workspace">
    <header className="settings-hero"><div><p className="eyebrow">Manager behavior</p><h1>Settings</h1><p>Set the maintenance policy, recovery schedule, and operational safeguards for Integration Manager.</p></div><button className="refresh-button" type="button" onClick={() => save.mutate(values)} disabled={save.isPending}><Save /> {save.isPending ? 'Saving…' : 'Save settings'}</button></header>
